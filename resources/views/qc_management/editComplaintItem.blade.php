                        ...
                        <div style="width: 800px; padding: 20px;margin-top: 20px;">
                            ...
                            <div class="el-form-item" id="material_toggle" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    ...
                                    <div class="el-select-dropdown-wrap">
                                        <input type="text" id="po_number" class="el-input" autocomplete="off" placeholder="生产单号" value="">
                                    </div>
                                </div>
                            ...
                            <div class="el-form-item" id="po_toggle" style="margin:20px 0 0 20px;display: none;">
                                <div class="el-form-item-div">
                                    ...
                                    <div class="el-select-dropdown-wrap">
                                        <input type="text" id="material_number" class="el-input" autocomplete="off" placeholder="物料名称" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    ...
                                    <input type="text" id="received_date"   data-name="接収日期" class="el-input" placeholder="接収日期" >
                                </div>
                            </div>
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                                    <label class="el-form-item-label" style="width: 100px;">不良品接収日期</label>
                                    <input type="text" id="samples_received_date"   data-name="不良品接収日期" class="el-input" placeholder="不良品接収日期" >
                                </div>
                            </div>
                            <div class="el-form-item" style="margin:20px 0 0 20px;">
                                <div class="el-form-item-div">
                ...
                <div class="el-panel addMaterial_from">
                    ...
                    <form id="addMaterial_from" class="formTemplate formBom normal">
                        <div class="div_con_wrapper">
                            <div class="actions">
                                <button class="button button_action button_check"><i class="fa fa-add"></i>添加物料</button>
                            </div>
                                ...
                                <div class="el-form-item-div">
                                    ...
                                    <div class="el-select-dropdown-wrap">
                                        <div class="el-select">
                                            ...
                                            <input type="text"  id="selectVal" class="el-input" value="--请选择--">
