 ...
 *其他出库明细modle
 */
class OtherOutstoreItem extends  Base
{
    public function __construct()
    {
        $this->table='ruis_other_outstore_item';
        //定义表别名
        $this->aliasTable=[
            'ooutsitem'=>$this->table.' as ooutsitem',
        ];
    }
	...
	{
		$list = $this->getLists([['other_outstore_id','=',$id]], 'id');
		foreach ($list as $val) 
			$ids[] = $val;
	...
	{
		$list = $this->getListsByWhere([['other_outstore_id','=',$id]]);
